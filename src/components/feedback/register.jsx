...
export default class Register extends React.Component {
  ...
  componentDidMount(props) {
    fetch('https://api.worktools.io/api/Engagement/?api_token='+ worktoolsToken +'&Project=' + this.props.params._id)
  ...
  handleSwipeLeft = (e) => {
    ...
    fetch('https://api.worktools.io/api/VolunteerReview/?api_token' + worktoolsToken, {
      headers: {
